...
class StoreProductRequestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'discount' => 'nullable|decimal:0.00,100|numeric',
            'category_id' => 'nullable|integer|exists:categories,id',
            'is_show' => 'nullable|numeric|min:0|max:1',
    ...
    public function messages()
    {
        return [
            ...
            'images.array' => __('image.images_array'),
            'images.*.file' => __('image.images_file'),
            'images.*.mimes' => __('image.images_mimes'),
            'images.*.max' => __('image.images_max'),
        ];
    }
}
